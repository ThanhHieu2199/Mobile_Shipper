...
import 'package:mobile_shipper/model/step_res.dart';
import 'package:mobile_shipper/repository/place_service.dart';
import 'package:mobile_shipper/resources/home_menu.dart';
import 'package:mobile_shipper/resources/widgets/location.dart';
import 'package:mobile_shipper/resources/widgets/pickup.dart';
...
//              markers: Set.of(markers.values),
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: location(onPlaceSelected),
                  ),
                ],
              ),
            ),
  ...
  void _addMarker(String mkId, PlaceItemRes place) async {
    ...
    //   await _mapController.addMarker(m.position);
    // }
    );
  }
